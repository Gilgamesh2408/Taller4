...
const campoCCpaswd = document.getElementById('ccpaswd')
...
formulario.addEventListener('submit', function (event) {
  ...
  const ccpaswdValue=campoCCpaswd.value;
  const ccpaswdRegex=/^[a-zA-Z0-9][#,%,/,&]{15,20}&/
  if(ccpaswdValue===""){
    alert("El campo CCpaswd debe estar lleno")
  }else if(!ccpaswdRegex.test(ccpaswdValue)){
    alert("El campo CCpaswd debe contener mayúsculas, numeros, letras y/o los siguientes caracteres [#,%,/,&]")
  }
